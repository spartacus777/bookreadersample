...
*/
package com.book.ui.folio.activity;
...
import com.book.ui.folio.adapter.FolioPageFragmentAdapter;
import com.book.ui.folio.fragment.FolioPageFragment;
import com.book.ui.folio.presenter.MainMvpView;
import com.book.ui.folio.presenter.MainPresenter;
import com.book.util.AppUtil;
import com.book.util.FileUtil;
import com.book.util.FolioReader;
import com.book.util.UiUtil;
import com.book.view.ConfigBottomSheetDialogFragment;
import com.book.view.DirectionalViewpager;
import com.book.view.ObservableWebView;
import com.book.view.StyleableTextView;
...
import static com.book.Constants.HIGHLIGHT_SELECTED;
...
public class FolioActivity
    ...
    private void loadAd(){
        AdRequest request = new AdRequest.Builder()
                ...
                .addTestDevice("CB26E5BBCBE22AF3FD44CEDC228C33DB")
                .addTestDevice("17B3CEFB41CD6FBE6E2A77367C119E09")
                .addTestDevice("0B6708CA2D9BCC80580B7BEEA2781532")
                .build();
